...
class ECKeyPair {
  ...
  // @notice Returns new ECKeyPair instance after multiplying this public key by some value
  ...
  // @notice Returns new ECKeyPair instance after multiplying this private key by some value
  // @param {RandomNumber, String} value number to multiply by, as class RandomNumber or hex
  // string with 0x prefix
  mulPrivateKey(value) {
  ...
  // @notice Generate ECKeyPair instance asynchronously from a transaction hash
